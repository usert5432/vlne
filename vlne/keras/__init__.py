"""
This module contains a collection of `keras` related objects.
"""
...
from .models.layer_norm import SimpleNorm
...
def setup_keras_custom_objects():
    ...
    get_custom_objects().update({ "SimpleNorm" : SimpleNorm })

setup_keras_custom_objects()
